...
* [SodiumPlus Methods](SodiumPlus#sodiumplus-methods)
  ...
  * [Encrypted streams](SodiumPlus/encrypted-streams.md)
    ...
    * [Stream Encryptor object](SodiumPlus/encrypted-streams.md#stream-encryptor-object)
    * [Stream Decryptor object](SodiumPlus/encrypted-streams.md#stream-decryptor-object)
